 ...
 ***********************************************************************************************
 */
CREATE TABLE IF NOT EXISTS public.instagram_post_processing_logs (
    -- 증가형 PK
...
CREATE INDEX IF NOT EXISTS idx_instagram_post_processing_logs_status 
    ON public.instagram_post_processing_logs (processing_status);

CREATE INDEX IF NOT EXISTS idx_instagram_post_processing_logs_priority 
    ON public.instagram_post_processing_logs (priority)
    WHERE processing_status = 'pending';

CREATE INDEX IF NOT EXISTS idx_instagram_post_processing_logs_error_flag
    ON public.instagram_post_processing_logs (is_error_occurred)
...
CREATE POLICY "instagram_post_processing_logs are visible to everyone" 
    ON public.instagram_post_processing_logs
    FOR SELECT 
...
-- (주의) update_updated_at_column() 함수가 미리 존재해야 합니다.
CREATE TRIGGER trigger_update_instagram_post_processing_logs_updated_at
    BEFORE UPDATE ON public.instagram_post_processing_logs
    FOR EACH ROW
